...
export const placeOrder = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    if (!address) throw new Error('Selected address is not available');
    ...
    if (paymentMethod === 'COD' || paymentMethod === 'WALLET') {
      ...
      if (paymentMethod === 'WALLET') {
        ...
        if (!wallet || wallet.balance < totalAmount) throw new Error('Insufficient wallet balance');
